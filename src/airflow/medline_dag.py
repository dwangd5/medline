...
task_update2hive = SparkSubmitOperator(
    ...
    conf={
        ...
        "spark.submit.pyFiles": "/usr/hdp/current/hive_warehouse_connector/pyspark_hwc-1.0.0.3.1.5.0-152.zip,hdfs:///tmp/airflow/medline.zip",
...
task_nlp_profiling = SparkSubmitOperator(
    ...
    conf={
        ...
        "spark.hadoop.hive.llap.daemon.service.hosts": "@llap0",
        "spark.hadoop.hive.zookeeper.quorum": "d1drlhadoop03.mdanderson.edu:2181,d1drlhadoop04.mdanderson.edu:2181,d1drlhadoop05.mdanderson.edu:2181",
        "spark.jars": "/usr/hdp/current/hive_warehouse_connector/hive-warehouse-connector-assembly-1.0.0.3.1.5.0-152.jar,hdfs:///tmp/airflow/spark-1.0-standalone.jar",
        "spark.executor.heartbeatInterval": "50s"},
    num_executors=20,
    executor_cores=5,
    executor_memory='10g',
